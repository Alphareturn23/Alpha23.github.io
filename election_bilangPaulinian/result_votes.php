...
<head>
    ...
    <link rel="stylesheet" href="../vote/assets/css/bootstrap.min.css">
    <script type="text/javascript" src="../assets/js/bootstrap.min.js"></script>
    <link rel="shortcut icon" href="../vote/assets/img/favicon.ico">
</head>
<body>
