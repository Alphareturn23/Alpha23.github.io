...
<nav class="navbar navbar-expand-sm bg-light navbar-light">
  ...
  <a class="navbar-brand" href="#">
    <img src="bilang_2.png" alt="logo" style="width:200px;">
  </a>
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
        <a class="nav-link" href="psgsaste.php" style="color:#000;font-weight:bold;">PSG SASTE</a>
    </li>
    <li class="nav-item">
...
<div class="jumbotron jumbotron-fluid" style="background-color:#1B2631;">
  <div class="container">
    <table>
        <tr>
            <td>
            <img src="SASTE.png" style="width:150px;">
            </td>
            <td>
                <h1 style="color:#fff;">PSG SASTE</h1>      
                <p style="color:#fff;">Total number of voters:
                <?php
                include "seer_carlos.php";
                $count = count_deptrows("votecount", "2");

                $count_1 = count_votesperyear("2", "1");
                $count_2 = count_votesperyear("2", "2");
                $count_3 = count_votesperyear("2", "3");
                $count_4 = count_votesperyear("2", "4");
                ?>
...
<div class="container">
    <div class="card">
      <div class="card-body">
      <?php
                $getSchoolwidePositions = get_where_custom("positions", "dsn_id", "3");
                    ...
                    <div class="card mb-3">
                        <table cellpadding="10">
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $c_votes = count_candidatevotedept($schoolwideCandidateID, "2");
                                    if ($c_votes==0) {
                                        $p_votes = 0;
                                    } else {
                                        if ( ($schoolwidePosition_id>=30) && ($schoolwidePosition_id<=33) ) {
                                            if ($year==1) {
