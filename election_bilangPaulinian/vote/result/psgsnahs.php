...
<nav class="navbar navbar-expand-sm bg-light navbar-light">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
        <a class="nav-link" href="psgsnahs.php" style="color:#000;font-weight:bold;">PSG SNAHS</a>
    </li>
  </ul>
</nav>
<div class="jumbotron jumbotron-fluid" style="background-color:#1B2631;">
  <div class="container">
    <table>
        <tr>
            <td>
            <img src="snahs.png" style="width:150px;">
            </td>
            <td>
                <h1 style="color:#fff;">PSG SNAHS</h1>      
                <p style="color:#fff;">Total number of voters:
                <?php
                include "seer_carlos.php";
                $count = count_deptrows("votecount", "4");

                $count_1 = count_votesperyear("4", "1");
                $count_2 = count_votesperyear("4", "2");
                $count_3 = count_votesperyear("4", "3");
                $count_4 = count_votesperyear("4", "4");
                ?>
                        ...
                        <table cellpadding="10">
                            <tr>
                                ...
                                <td>
                                    <?php
                                                                                                //dept_id
                                    $c_votes = count_candidatevotedept($schoolwideCandidateID, "4");
                                    if ($c_votes==0) {
                                        $p_votes = 0;
                                    } else {
