...
<div class="container">
<form method="post" action="reviewvotes.php" id="user_form">
    <br>
    ...
    <div class="card border-default col-lg-12" style="padding: 0 0; margin-left:30px; ">
        <div class="card-header border-default" style="background-color:#1B4F72;margin:0px;">
              <b style="color:#fff;">PSG SASTE</b>
        </div>
        <div class="card-body" style="background-color:#F2F3F4;">
            <?php
            ...
            <?php
                if  ( ($schoolwidePosition_id>29) && ($schoolwidePosition_id<34) ) {
                    $voter_dept_id = $_SESSION["dept_id"];
