...
<head>
    ...
    <title>Election Ballot | Bilang Paulinian</title>
...
<form method="post" action="reviewvotes.php">
    ...
    <!-- first row -->
    <tr><td>
    <div class="card border-default col-lg-12" style="margin-right:200px;padding: 0 0; margin-bottom:20px; margin-left:30px;">
    ...
    <div class="card border-default col-lg-12" style="padding: 0 0; margin-left:30px; ">
        <div class="card-header border-default" style="background-color:#5e3571;margin:0px;">
              <b style="color:#fff;">PSG SITE</b>
        </div>
        <div class="card-body" style="background-color:#F2F3F4;">
            <?php
            ...
            <?php
                ...
                if  ( ($schoolwidePosition_id>11) && ($schoolwidePosition_id<14) ) {
                    $custom_query = "SELECT candidates.candidates_id, candidates.student_id, candidates.position_id, students.fname, students.lname, students.dept_id, students.year, students.site_course
                    FROM candidates
                    INNER JOIN students ON candidates.student_id=students.student_id
                    WHERE candidates.position_id='$schoolwidePosition_id'
                    AND students.dept_id='$voter_dept_id'
                    AND students.site_course='$voter_course'
